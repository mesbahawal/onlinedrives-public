...
class File extends FileSystemItem
{
    ...
    {
        return Yii::t('OnlinedrivesModule.base', "File");
    }
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(),[
            'id' => 'ID',
            'parent_folder_id' => Yii::t('OnlinedrivesModule.models_File', 'Folder ID')
        ]);
    }
    ...
    public function getUrl()
    {
        if ($this->parentFolder === null) {
            Yii::warning('Could not get parent folder for file id: ' . $this->id, 'onlinedrives');
            return '';
        }
    ...
    {
        return $this->content->container->createUrl('/onlinedrives/edit/file', ['id' => $this->getItemId()]);
    }
