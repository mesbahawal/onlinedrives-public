...
use humhub\modules\onlinedrives\models\rows\BaseFileRow;
use humhub\modules\onlinedrives\models\rows\FileSystemItemRow;
use humhub\modules\onlinedrives\models\rows\FolderRow;
...
use humhub\modules\onlinedrives\models\rows\FileRow;
...
class FileList extends Widget
{
    ...
    {
        /** @var $module Module */
        $module = Yii::$app->getModule('onlinedrives');
    ...
    public function run()
    {
        ...
        $itemsSelectable = !$this->folder->isAllPostedFiles() && ($canWrite || Yii::$app->getModule('onlinedrives')->isZipSupportEnabled());
     ...
     * 
     * @return \humhub\modules\onlinedrives\models\FileSystemItem[]
     */
