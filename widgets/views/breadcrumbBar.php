...
if ($folder->content->isPublic()) {
    ...
    $visibilityTitle = Yii::t('OnlinedrivesModule.base', 'This folder is public.');
} else {
    $visibilityIcon = 'fa-lock';
    $visibilityTitle = Yii::t('OnlinedrivesModule.base', 'This folder is private.');
}
...
<div class="panel panel-default" style="margin-bottom:10px;">
    <div class="panel-head">
        <ol id="onlinedrives-crumb" class="breadcrumb" dir="ltr">
            <?php foreach ($folder->getCrumb() as $parentFolder): ?>
                <?php $url = $contentContainer->createUrl('/onlinedrives/browse/index', ['fid' => $parentFolder->id]); ?>
                <li>
                    <a href="<?= $url ?>">
